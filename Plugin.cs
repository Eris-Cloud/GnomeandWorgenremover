...
namespace PotatoFamine2
{
    public class Plugin : IDalamudPlugin
    {
        ...
        private void ChangeRace(IntPtr customizeDataPtr, Race targetRace, bool ForceChange = false)
        {
            ...
            {
                shouldChange = customData.Race == Race.LALAFELL || customData.Race == Race.HROTHGAR;
                isHroth = customData.Race == Race.HROTHGAR;
            }
            else
            {
                shouldChange = customData.Race != targetRace;
            }
            lastWasSelf = false;
